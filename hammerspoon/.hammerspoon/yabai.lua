...
hyper:bind({"alt"},   "/", function() hs.execute("yabai -m space --padding rel:10:10:10:10; yabai -m space --gap rel:10", true) end)
hyper:bind({"cmd"},   "/", function() hs.execute("yabai -m space --padding abs:10:10:10:10; yabai -m space --gap abs:10", true) end)
hyper:bind({"ctrl"},  "/", function() hs.execute("yabai -m space --padding rel:-10:-10:-10:-10; yabai -m space --gap rel:-10", true) end)
hyper:bind({"shift"}, "/", function() hs.execute("yabai -m space --padding rel:-10:-10:-10:-10; yabai -m space --gap rel:-10", true) end)
