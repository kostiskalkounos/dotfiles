...
local function rebuild_active_string(c)
  ...
  c.active = HL_ACTIVE .. SPACE .. c.filename .. "%<" .. c.icon_active .. ACTIVE_SECOND .. c.git .. SEPARATOR .. c.diag .. c.branch .. ACTIVE_THIRD
  c.active_tail = HL_ACTIVE .. SPACE .. c.filename_tail .. "%<" .. c.icon_active .. INACTIVE_SECOND
end
