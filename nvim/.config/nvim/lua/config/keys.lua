...
set("n", "<leader>q", function() b.close_buffer() end, unique)

set("n", "<leader>B", function() require "spectre".open() end, unique)
set("n", "<leader>b", function() require "spectre".open_visual({ select_word = true }) end, unique)
set("v", "<leader>b", function() require "spectre".open_visual() end, unique)
