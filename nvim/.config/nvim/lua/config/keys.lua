...
set("n", "<leader>B", "<cmd>lua require('spectre').open()<CR>", unique)
...
set("n", "<leader>b", "<cmd>lua require('spectre').open_visual({select_word=true})<CR>", unique)
...
set("v", "<leader>b", "<cmd>lua require('spectre').open_visual()<CR>", unique)

set("n", "<F1>", ":lua require'dap'.continue()<CR>", default)
set("n", "<F2>", ":lua require'dap'.step_over()<CR>", default)
set("n", "<F3>", ":lua require'dap'.step_into()<CR>", default)
set("n", "<F4>", ":lua require'dap'.step_out()<CR>", default)
set("n", "<F5>", ":lua require'dap'.step_back()<CR>", default)
set("n", "<F6>", ":lua require'dap'.repl.open()<CR>", default)
set("n", "<F7>", ":lua require'dap'.toggle_breakpoint()<CR>", default)
set("n", "<F8>", ":lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>", default)
