...
vim.keymap.set("v", "<S-Tab>", "<gv", default)
vim.keymap.set("v", "<Tab>", ">gv", default)
vim.keymap.set("v", ">", ">gv", default)
...
vim.keymap.set("n", "<leader>+", ":set nu! rnu!<CR>", unique)
...
vim.keymap.set("n", "<leader>G", "<cmd>Gitsigns blame<CR>", unique)
...
vim.keymap.set("n", "<leader>U", "<cmd>DiffviewRefresh<CR>", unique)
vim.keymap.set("n", "<leader>V", "<cmd>set paste!<CR>", unique)
vim.keymap.set("n", "<leader>W", "<cmd>FormatToggle<CR>", unique)
...
vim.keymap.set("n", "<leader>d", "<cmd>Telescope resume<CR>", unique)
...
vim.keymap.set("n", "<leader>q", "<cmd>lua require('config.buffers').close_buffer()<CR>", unique)
