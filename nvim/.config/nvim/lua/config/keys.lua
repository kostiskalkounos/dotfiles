...
set("n", "<leader>?", "<cmd>bufdo set nu! rnu!<cr>", unique)
...
set("n", "<leader>R", function() require("grug-far").open() end, unique)
set("n", "<leader>S", function() require("neogit").open() end, unique)
set("n", "<leader>Z", function() require("fzf-lua").zoxide() end, unique)
set("n", "<leader>a", function() require("fzf-lua").live_grep() end, unique)
set("n", "<leader>b", function() require("fzf-lua").undotree() end, unique)
...
set("v", "<leader>R", function() require("grug-far").with_visual_selection() end, unique)
